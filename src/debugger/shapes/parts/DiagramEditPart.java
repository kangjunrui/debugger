...
import debugger.shapes.model.commands.ShapeCreateCommand;
...
public class DiagramEditPart extends AbstractGraphicalEditPart implements
	...
	public void activate() {
		if (!isActive()) {
			...
			dlg=(CommentDialog)getCastedModel().getEditor().getAdapter(CommentDialog.class);
		}
	}
	...
	private class ShapesXYLayoutEditPolicy extends XYLayoutEditPolicy {
		...
		protected Command getCreateCommand(CreateRequest request) {
			...
			}else if (childClass == Shape.class){
