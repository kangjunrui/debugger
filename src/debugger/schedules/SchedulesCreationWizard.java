...
/**
 * Create new new .schedules-file. Those files can be used with the SchedulesEditor
 * (see plugin.xml).
 * 
 */
public class SchedulesCreationWizard extends Wizard implements INewWizard {
	...
	private class CreationPage extends WizardNewFileCreationPage {
		private static final String DEFAULT_EXTENSION = ".dsc";
		...
		CreationPage(IWorkbench workbench, IStructuredSelection selection) {
			super("schedulesCreationPage1", selection);
